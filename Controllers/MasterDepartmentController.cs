...
namespace TrainingAPI.Controllers
{
    ...
    [ApiController]
    public class MasterDepartmentController : iFinancingController
    {
        public MasterDepartmentController(IConfiguration configuration, IWebHostEnvironment hostingEnvironment) : base(configuration, hostingEnvironment)
        {

        }

        private string _tableName = "MASTER_DEPARTMENT";
