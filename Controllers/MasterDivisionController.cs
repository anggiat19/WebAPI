...
namespace TrainingAPI.Controllers
{
    ...
    [ApiController]
    public class MasterDivisionController : iFinancingController
    {
        public MasterDivisionController(IConfiguration configuration, IWebHostEnvironment hostingEnvironment) : base(configuration, hostingEnvironment)
        {

        }

        private string _tableName = "MASTER_CONTROLLER";
