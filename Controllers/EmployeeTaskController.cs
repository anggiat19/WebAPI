...
namespace TrainingAPI.Controllers
{
    ...
    [ApiController]
    public class EmployeeTaskController : iFinancingController
    {
        public EmployeeTaskController(IConfiguration configuration, IWebHostEnvironment hostingEnvironment) : base(configuration, hostingEnvironment)
        {

        }

        private string _tableName = "EMPLOYEE_TASK";
