...
namespace TrainingAPI.Controllers
{
    ...
    [ApiController]
    public class EmployeeController : iFinancingController
    {
        public EmployeeController(IConfiguration configuration, IWebHostEnvironment hostingEnvironment) : base(configuration, hostingEnvironment)
        {
